<template>
  <div class="mb-6">
    ...
    <div v-for="log in logs" class="py-4 flex gap-x-4 shadow-cs2 w-full">
      <div
        class="flex flex-wrap comp:flex-nowrap comm:gap-9 w-full justify-between"
      >
        <div
          class="text-gray-c-500 font-normal pt-1 text-h3 align-middle mobile:text-h4 tablet:text-h4 comp:px-4"
        >
