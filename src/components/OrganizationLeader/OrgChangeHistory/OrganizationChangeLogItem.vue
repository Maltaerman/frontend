  ...
  <div class="mb-6">
    ...
    >
      ...
      >
        <div
          class="
            pt-1 align-middle text-h3 font-normal
            text-gray-c-500 comp:px-4 tablet:text-h4 mobile:text-h4
          "
        >
        ...
        <div class="order-3 w-full shrink grow comp:order-2 mobile:pr-6">
          ...
          >
            <div class="group relative flex cursor-default flex-wrap gap-4">
              ...
              <div class="flex gap-2">
                ...
                <p
                  class="my-auto grow text-base uppercase tablet:text-h4 mobile:text-h4"
          ...
          <router-link
            class="
              cursor-pointer text-h3 font-semibold text-gray-c-500 tablet:text-h4 mobile:text-h4
            "
        ...
        <div class="order-2 comp:order-3">
          ...
          >
            <div class="relative">
              <div class="h-full w-0.5 bg-blue-c-500" />
              <SVG_eye class="hide-button-svg" />
            </div>
            <!--<SVG_eye v-if="log.hidden" class="hide-button-svg"/>-->
            <div
              v-if="log.hidden"
              class="hidden whitespace-nowrap comp:block"
            >
...
export default {
  ...
  methods: {
    ...
    getLocationOverviewRoute(log) {
      ...
      if (log.position) url += `&lat=${log.position.lat}&lng=${log.position.lng}`
      return url
    },
  },
}
