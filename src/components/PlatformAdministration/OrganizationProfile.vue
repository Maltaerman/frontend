<template>
  ...
  >
    ...
    <div
      class="rounded-lg border border-gray-c-300 p-4 mt-6 mb-8 flex mobile:flex-col justify-between gap-4"
    >
      <div>
        <div>
      ...
      <div class="font-medium flex gap-2 justify-center">
        <button-text-1
          class="group p-2 align-middle h-min"
          @click="ShowEditModal"
        >
          <svg
            class="inline-block mt-[-3px] mr-1.5"
            fill="none"
            height="19"
            viewBox="0 0 19 19"
            width="19"
