<template>
	<div
v-if="isVisible" class="h-[calc(100%-64px)] fixed z-[100] w-full duration-200"
			 :class="{'bg-black/70' : animTrigger, 'bg-black/0' : !animTrigger}" @click="hide">
		<transition name="appear">
			<div v-if="animTrigger" class="w-[300px] bg-white shadow-cs1 h-full" @click.stop>
				<div class="flex flex-nowrap gap-3.5 items-center h-[76px] shadow-cs2 p-4">
					<div class="flex items-center">
						<img class="w-7 h-auto" :src="currentUserIconLink">
					</div>
					<div class="gap-1.5">
				...
				<div class="py-0.5">
					...
					<button v-if="user.role === userRoles.aidWorker"
